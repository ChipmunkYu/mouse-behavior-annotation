...
当前分支已本地完成 P1—P4 低码率展示代理代码，尚未提交、推送或部署。生产 release、schema 与实际能力只查仓库外“网站服务器文件清单”，本文不复制提交号。
...
- [低码率展示代理视频实现计划](计划/低码率展示代理视频实现计划.md)：当前 P4 权威计划；P1—P4 代码已本地完成，最终不支持历史回填或独立 fallback，尚未提交、推送或部署。
